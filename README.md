...
@theme {
  ...
  --color-secondary: #221f3d;

  --color-light-50: #d6c7ff;
...
@layer components {
  ...
  .wrapper {
    @apply px-5 py-12 xs:p-10 max-w-7xl w-full md:p-0 mx-auto flex flex-col relative z-10;
  }
  ...
  .movie-modal {
    @apply bg-primary w-full p-8 md:p-10 lg:py-15 lg:px-30;

    & .content {
      @apply bg-dark-100  px-6 py-7 md:p-7 lg:p-12.5 rounded-xl space-y-6 md:space-y-8;
      box-shadow: 0px 12px 32px 0px #cecefb05 inset;
      box-shadow: 0px 0px 100px 0px #ab8bff4d;
    }
  }
  .label {
    @apply min-w-25 w-37.5 text-light-200 text-lg;
  }
  .btn-gradient {
    @apply text-primary px-5 py-2 rounded-md font-semibold transition-all bg-clip-text flex items-center gap-1.5 ml-auto;
    background: linear-gradient(90deg, #d6c7ff 0%, #ab8bff 100%);
  }
  /* Pagination Styles */
  .pagination-btn {
    @apply p-3 bg-dark-100 rounded-lg cursor-pointer disabled:cursor-not-allowed disabled:opacity-50;
  }
}
